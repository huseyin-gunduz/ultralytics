...
true_boxes, true_classes = load_labels('D:/datasets/diatom/YoloDiatomDataset800x600-28/labels/all/1092_HV.txt')
pred_boxes, pred_classes = load_labels('predictions/1092_HV.png/labels/1092_HV.txt')
...
for i, pred_box in enumerate(pred_boxes):
    ...
    # IoU değerlerini yazdır
    print(f"Tahmin kutusu {i + 1} için IoU değerleri: {iou_scores}")

    max_iou_index = np.argmax(iou_scores)

    if iou_scores[max_iou_index] >= iou_threshold and max_iou_index not in matched_gt:
